...
/media/soterea/Data_ssd/work/02_FrameWork/caffe-jacinto/build/tools/caffe.bin train \
--solver="/media/soterea/Data_ssd/work/YYZhang/train_file/2020/5/train_fusion_higher_feature/sparse/solver.prototxt" \
--weights="/media/soterea/Data_ssd/work/YYZhang/Train_restore/base_line/model2/BSD_Combi_d-n_191217_iter_56000.caffemodel" \
--gpu=0 2>&1 | tee /media/soterea/Data_ssd/work/YYZhang/log_path/2020/5/sparse/train_log_sparse

...
--gpu=0 2>&1 | tee /media/soterea/Data_ssd/work/YYZhang/log_path/2020-3-4-train_4xaugmentation_change_loss_raito_dilation/l1_reg/train_log_l1_reg


/media/soterea/Data_ssd/work/02_FrameWork/caffe-jacinto/build/tools/caffe.bin train \
--solver="/media/soterea/Data_ssd/work/YYZhang/train_file/2020-3-4-train_4xaugmentation_change_loss_raito_dilation/sparse/solver.prototxt" \
--weights="/media/soterea/Data_ssd/work/YYZhang/Train_restore/2020-3-4-train_4xaugmentation_change_loss_raito_dilation/l1_reg/BSD_train_l1reg_d-n_iter_30000.caffemodel" \
--gpu=0 2>&1 | tee /media/soterea/Data_ssd/work/YYZhang/log_path/2020-3-4-train_4xaugmentation_change_loss_raito_dilation/sparse/train_log_sparse

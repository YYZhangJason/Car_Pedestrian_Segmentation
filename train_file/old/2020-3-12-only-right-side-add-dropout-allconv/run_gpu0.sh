...
/media/soterea/Data_ssd/work/02_FrameWork/caffe-jacinto/build/tools/caffe.bin train \
--solver="/media/soterea/Data_ssd/work/YYZhang/train_file/2020-3-12-only-right-side-add-dropout-allconv/sparse/solver.prototxt" \
...
--gpu=1 2>&1 | tee /media/soterea/Data_ssd/work/YYZhang/log_path/2020-3-12-only-right-side-add-dropout-allconv/sparse/train_log_sparse

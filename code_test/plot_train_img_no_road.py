...
'''
@author: YYZhang
@file: plot_train_img_no_road.py
@time: 4/1/20 9:35 AM
@purpose:画出训练时候没有road的IOU,acc,loss图
'''
import re
import string
import numpy as np
...
def main(url,cls_dic,title):
    ...
    fig_save_dir = os.path.join('/media/soterea/Data_ssd/work/YYZhang/log_path/2020-3.30-4.10/3.31-delete_road/sparse','Training_plot')
    print(fig_save_dir)
...
if __name__ == '__main__':
    log_file = '/media/soterea/Data_ssd/work/YYZhang/log_path/2020-3.30-4.10/3.31-delete_road/sparse/train_log_sparse'
    title = 'test'
    cls_dic ={2:'Ped',3:'unused',4:'Car'}

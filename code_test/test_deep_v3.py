...
'''
@author: YYZhang
@file: test_deep_v3.py
@time: 4/27/20 4:16 PM
@purpose:
'''
#!/usr/bin/env python3
# encoding: utf-8
...
def res_from_pc():
	...
	show_img = False
	save_res = True
	save_dir = '/media/soterea/Data_ssd/work/YYZhang/test_file/experiment_results/2020'

	model = '/media/soterea/Data_ssd/work/YYZhang/train_file/2020/4.14_baseline_scooter_as_ped/sparse/deploy.prototxt'
	weights = '/media/soterea/Data_ssd/work/YYZhang/Train_restore/2020/sparse/focal_loss/BSD_train_sparse_d-n_iter_60000.caffemodel'
	...
	pred_path = '/media/soterea/Data_ssd/work/YYZhang/test_file/deeplabv3+/zhangyuyu1314-tensorflow-deeplab-v3-plus-master/tensorflow-deeplab-v3-plus/dataset/save_deep/gtID_simple'
	for frm_id in range(num_frm):
		...
		'''get pc res'''
		splt_name = img_path.split('/')
		prediction_name = os.path.join(pred_path,splt_name[-1])
		result_deep = cv2.imread(prediction_name)

		prediction = result_deep[:,:,0]

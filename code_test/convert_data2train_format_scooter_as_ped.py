...
def main():
    ...
    img_dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/only_test_img/bsd_day/raw_img'
    label_dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/only_test_img/bsd_day/gt_color'
    save_Dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/only_test_img/bsd_day'
    ## step1

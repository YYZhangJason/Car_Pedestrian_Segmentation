...
def res_from_pc():
	...
	show_img = False
	save_res = True
	record_file = '/media/soterea/Data_ssd/work/YYZhang/data/test_data/only_day_img/record.csv'
	save_dir = '/media/soterea/Data_ssd/work/YYZhang/test_file/experiment_results/2020-3-27_V_BSD_LR_D_SEG_01_test'
	...
	temp_image_path = '/media/soterea/Data_ssd/work/YYZhang/data/test_data/data_deal_with_code_highlight/results'

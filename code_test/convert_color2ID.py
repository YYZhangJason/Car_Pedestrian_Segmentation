...
'''
@author: YYZhang
@file: convert_color2ID.py
@time: 4/27/20 2:11 PM
@purpose:将彩色标签转换成黑白
'''
...
'''
@author: YYZhang
@file: convert_data2train_format_no_road.py
@time: 3/31/20 3:05 PM
@purpose:将自行车/摩托车/三轮车当作人进行计算
'''
"""
...
def main():
    ...
    # img_dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/20191001/bsd_day/raw_img'
    # label_dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/20200323/bsd_night/gt_color'
    # save_Dir = '/media/soterea/Data_ssd/work/YYZhang/data/train_data/20200323/bsd_night'
    label_dir = '/media/soterea/Data_ssd/work/YYZhang/test_file/deeplabv3+/zhangyuyu1314-tensorflow-deeplab-v3-plus-master/tensorflow-deeplab-v3-plus/dataset/temp'
    save_Dir = '/media/soterea/Data_ssd/work/YYZhang/test_file/deeplabv3+/zhangyuyu1314-tensorflow-deeplab-v3-plus-master/tensorflow-deeplab-v3-plus/dataset/save_deep'
    save_dir_gtColor = label_dir
    # step2
    ...
    map_dic = {0:0,7:1,24:2,25:2,26:4,27:4,28:4,33:3}
